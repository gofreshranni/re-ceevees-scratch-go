...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Scratch & Win exciting school gifts, free notebooks and instant discounts at Ceevees Mart, Ranni." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Ceevees Mart — Back to School Scratch & Win" },
      { name: "twitter:description", content: "Scratch & Win exciting school gifts, free notebooks and instant discounts at Ceevees Mart, Ranni." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/IpJDZ7dc5xYUsl16CsBHSkdf2ZW2/social-images/social-1779706856121-ChatGPT_Image_May_25,_2026,_03_00_54_PM.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/IpJDZ7dc5xYUsl16CsBHSkdf2ZW2/social-images/social-1779706856121-ChatGPT_Image_May_25,_2026,_03_00_54_PM.webp" },
    ],
    links: [
